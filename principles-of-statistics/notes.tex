...
Consider random vectors $X, Y$, here assumed to be from $N(\mu_x, \sigma_x), N(\mu_y, \sigma_y)$. Then their correlation is $\rho_{x,y} = \frac{Cov(X,Y)}{\sqrt{VarX}\sqrt{VarY}}$. For $X_1, \ldots, X_n;Y_1,\ldots,Y_n$ jointly iid, this can be estimated by the empirical correlation
\[
